...
arrFunc = function (str1: string, str2: string, str3: string) {
  let result = [str1, str2, str3];
  return result;
};

//c) Design another implementation that returns an array, with the three strings uppercased.
let upperCaseArr: MyFunc;

upperCaseArr = function (str1: string, str2: string, str3: string) {
...
let f3 = function (str1: string, num1: number) {
  return [str1, num1];
};
